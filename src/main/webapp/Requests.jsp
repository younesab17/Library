...
%>
      <tbody>
        ...
        <tr>
          ...
          <input type="hidden" name="username" value="<%= emprunt.get(1) %>">
          <input type="hidden" name="date_d" value="<%= emprunt.get(2) %>">
          <input type="hidden" name="date_r" value="<%= emprunt.get(3) %>">
          	<input type="submit" class="btn btn-edit" value="Accepter" name="action">
            <input type="submit" class="btn btn-delete" value="Refuser" name="action">
          </form>
          </td>
        </tr>
      <%
